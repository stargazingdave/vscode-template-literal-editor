...
function activate(_context) {
    ...
    async function activateSubdocument(language, editor, start, end, behavior) {
        ...
        const stripOnOpen = cfg.get('stripIndentOnOpen', true); // default can be false if you prefer
...
function behaviorFrom(defaults, pragma) {
    var _a, _b;
    return {
        offsetIndentOnSync: (_a = pragma === null || pragma === void 0 ? void 0 : pragma.offset) !== null && _a !== void 0 ? _a : defaults.offsetIndentOnSync,
        extraIndentLevels: (_b = pragma === null || pragma === void 0 ? void 0 : pragma.levels) !== null && _b !== void 0 ? _b : defaults.extraIndentLevels,
    };
}
